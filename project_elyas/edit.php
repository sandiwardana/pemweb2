    ...
    <div class="container">
        ...
        <form method="POST" class='ms-4 me-4' action="proses.php">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="kode" name="kode" type="text" required="required" value='<?= $pasien['kode']; ?>'
                    class="form-control">
                </div>
            </div>
                ...
                <div class="col-8">
                    <div class='form-check form-check-inline'>
                        <input id="gender_laki" name="gender" type="radio" required="required"
                            <?=($pasien['gender']=='L' ? 'checked' :'') ?> class="form-check-input"
                        value="Laki-Laki">
            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-8">
                    <input id="email" name="email" type="text" required="required" value='<?= $pasien['email']; ?>'
                    class="form-control">
                </div>
            </div>
            <div class="form-group row mt-2">
                ...
                <div class="col-8">
                    <input id="alamat" name="alamat" type="text" required="required" value='<?= $pasien['alamat']; ?>'
                    class="form-control">
                </div>
            </div>
            <div class="form-group row mt-2">
                ...
                <div class="col-8">
                    <select id="kelurahan" name="kelurahan" class="form-select" required="required">
                        ...
                        ?>
                        <option value="<?= $kelurahan['id'];?>" <?=$selected; ?>>
                            <?= $kelurahan['nama']; ?>
                        </option>
